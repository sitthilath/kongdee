...
class ForgetPasswordOTPProvider extends ChangeNotifier {
  ...
  Future<void> verifyPhone(String phoneNo, BuildContext context) async {
    ...
    final PhoneCodeSent smsCodeSent = (String verId, [int forceCodeResend]) {
      ...
      Navigator.of(context).pushNamed('/otppageforgetpassword',
          arguments: ForgetPasswordArgument(
              verificationIdArg: verificationId, phoneNoArg: phoneNo,context: context));
    };
