...
class OTPPageLogin extends StatefulWidget {
  @override
  _OTPPageLoginState createState() => _OTPPageLoginState();
}
...
class _OTPPageLoginState extends State<OTPPageLogin> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      Provider.of<LoginOTPProvider>(context,listen:false).startTimer();
    });
  ...
  void dispose() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      if(mounted) {
        if (Provider
            .of<LoginOTPProvider>(context, listen: false)
            .timer != null) {
          Provider
              .of<LoginOTPProvider>(context, listen: false)
              .timer
  ...
  Widget build(BuildContext context) {
            ...
            child: Column(
              children: [
                ...
                Consumer<LoginOTPProvider>(
                   builder: (context, loginNotify, child) =>
                   TextButton(

                    onPressed: loginNotify.timeRemain != 0 ? null : () =>

                     loginNotify.verifyPhone(args.password, args.phoneNoArg, context)
                    ,
   ...
   buildTimer() {
    return Consumer<LoginOTPProvider>(
      builder: (context, value, child) =>
